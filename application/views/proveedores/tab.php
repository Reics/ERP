...
<section style="margin-left: 50px; margin-right: 50px;">
    <div class="container">
        ...
        <ul class="nav nav-tabs">
            <li class="active">
                <a data-toggle="tab" href="#fichas">Fichas</a>
            </li>
            <li>
                <a data-toggle="tab" href="#contactos">Contactos</a>
            </li>
            <li>
                <a data-toggle="tab" href="#mapas">Mapas</a>
            </li>
        </ul>
            ...
            <tr>
                <form class="form-inline">
                    <div class="form-group">
                        ...
                        <td><input type="text" class="form-control" id="idProvador"></td>
                    </div>
                </form>
            </tr>
            <tr>
             ...
             <tr> 
                <form class="form-inline">
                    <div class="form-group">
                        ...
                        <td><input type="text" class="form-control" id="Empresa"></td>
                    </div>
                </form>
            </tr>
            <tr>
                <form class="form-inline">
                    <div class="form-group">
                        ...
                        <td><input type="text" class="form-control" id="titulodecortesia"></td>
                    </div>
                </form>
                </tr>
                <tr>
                <form class="form-inline">
                    <div class="form-group">
                        ...
                        <td><input type="text" class="form-control" id="puestofuncion"></td>
                    </div>
                </form>
                </tr>
                <tr>
                ...
                <form class="form-inline">
                    <div class="form-group">
                        ...
                        <td><input type="text" class="form-control" id="cosigopostal"></td>
                    </div>
                    <div class="form-group">
                        <td><label for="Poblacion">Población: </label></td>
                        <td><input type="text" class="form-control" id="Poblacion"></td>
                    </div>
                </form>
                </tr>
                <tr>
                <form class="form-inline">
                    <div class="form-group">
                        ...
                        <td><input type="text" class="form-control" id="Pais"></td>
                    </div>
                </form>
                </tr>
                <tr>
                <form class="form-inline">
                    <div class="form-group">
                        ...
                        <td><input type="text" class="form-control" id="Provincia"></td>
                    </div>
                </form>
                </tr>
                <tr>
                <form class="form-inline">
                    <div class="form-group">
                        ...
                        <td><input type="text" class="form-control" id="numero1"></td>
                    </div>
                    <div class="form-group">
                        <td><label for="numero2">Telefono Particular: </label></td>
                        <td><input type="text" class="form-control" id="numero2"></td>
                    </div>
                </form>
                </tr>
                <tr>
                <form class="form-inline">
                    <div class="form-group">
                        ...
                        <td><input type="text" class="form-control" id="numero3"></td>
                    </div>
                </form>
                <tr>
                <form class="form-inline">
                    <div class="form-group">
                        ...
                        <td><input type="text" class="form-control" id="correo1"></td>
                    </div>
                    <div class="form-group">
                        <td><label for="correo2">Email 2: </label></td>
                        <td><input type="text" class="form-control" id="correo2"></td>
                    </div>
                </form>
                </tr>
                <tr>
                <form class="form-inline">
                    <div class="form-group">
                        ...
                        <td><input type="text" class="form-control" id="Web"></td>
                    </div>
                    <div class="form-group">
    ...
    <div id="contactos" class="tab-pane fade">
        ...
        <div class="container">
            <hr>
            <div align="right">
                <button type="submit" class="btn btn-primary" name="agregarCompetencia" id="agregarCompetencia">Agregar Contacto</button>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <table class="table table-striped display" > <!-- Tabla de competencias -->
                ...
                <tbody>
                    <tr>
                        <td>
                            <img src ="./contacto.png" alt="Imagen de la direccion" width="70%">
                        </td>
                        <td>
