...
<hr>
            <form class="form-horizontal">
                <fieldset>
                    ...
                    <!-- Form Name -->
                    <legend align="center">AGREGAR PROFESIONISTA</legend>
                    <div class="col-xs-6">
...
<div class="col-xs-10" align="left">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class="col-xs-6">
      <input id="numint1" name="numint1" type="text" placeholder="" class="form-control input-md" >
    </div>
  </div>
      ...
      <input id="numext1" name="numext1" type="text" placeholder="" class="form-control input-md" >
                  ...
                  <div class="col-xs-4" style="float:right; margin:40px;" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-6">
                                    <input id="telCasa" name="telCasa" type="text" placeholder="" class="form-control input-md" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-6">
                                    <input id="movil2" name="movil2" type="text" placeholder="" class="form-control input-md" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-6">
                                    <input id="telOficina" name="telOficina" type="text" placeholder="" class="form-control input-md" >
 ...
 <div class="col-xs-10">
                       ...
                       <div class="form-group">
                            ...
                            <div class="col-xs-8">
                                <input id="calle2" name="calle2" type="text" placeholder="" class="form-control input-md">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-xs-8">
                                <input id="numint2" name="numint2" type="text" placeholder="" class="form-control input-md">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-xs-8">
                                <input id="numext2" name="numext2" type="text" placeholder="" class="form-control input-md" >
